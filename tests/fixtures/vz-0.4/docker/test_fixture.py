...
# This fixture tree is pinned by digest and refuses generated bytecode, so
# importing its modules here must not leave a __pycache__ behind.
sys.dont_write_bytecode = True

from validate import ROOT, validate, validate_inputs  # noqa: E402
