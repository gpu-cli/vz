...
TABLE = (
    ...
    _c("docker.compose.create", "compose", ("compose-create", "effective_configuration")),
    _c("docker.compose.up", "compose", "compose-up-order"),
    _c("docker.compose.dependency_ordering", "compose", ("compose-up-order", "effective_configuration")),
